...
namespace Face3DReconstruction.ViewModelLocator
{
    public static class ViewModelLocator
    {
           ...
           DependencyPropertyChangedEventArgs e)
        {
            ...
            try
            {
                var getVMInstanceMethod = Ioc.Default.GetType().GetMethod("GetRequiredService").MakeGenericMethod(viewModelType);
                viewModel = getVMInstanceMethod.Invoke(Ioc.Default, null);
                if (viewModel == null)
                {
